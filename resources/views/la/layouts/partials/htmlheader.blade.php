<head>
    <meta charset="UTF-8">
    <title>@hasSection('htmlheader_title')@yield('htmlheader_title') - @endif{{ config('laraadmin.sitename') }}</title>
    ...
    <!-- iCheck -->
    <link href="{{ asset('la-assets/plugins/select2/select2.min.css') }}" rel="stylesheet" type="text/css" />
